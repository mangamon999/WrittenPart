...
\bancaum{Prof. Xxxxx Xxxxxx}
\bancadois{Prof. Xxxxx Xxxxxx} % comente se sua banca tiver só um professor
%\bancatres{Fulanim de Sicrano}% comente se sua banca tiver só um professor
\defesa{dd de MM de yyyy}
